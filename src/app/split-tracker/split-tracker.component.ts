...
import { SplitTrackerDialog } from './split-tracker-dialog/split-tracker-dialog';

//https://canvasjs.com/angular-charts/ use this link!!!

@Component({
  selector: 'split-tracker',
  styleUrls: ['split-tracker.component.scss'],
  templateUrl: 'split-tracker.component.html',
  animations: [
...
export class SplitTrackerComponent implements OnInit {
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(SplitTrackerDialog, {
      width: '500px',
